...
*/
var mv_categories
var mathView_translator

define("qtype_webwork_opaque/mv_locale_fr", ["jquery"], function(a) {
    var b = {
        init: function init() {
			

mathView_translator=["Base","Parenthèse","Trigonométrie","Logarithme","Interval","Autres","Version FR ", "Éditeur d'équation","Insérer","Annuler", "Trigonométrie Inverse","Exposant","Opérations"];

mv_categories =
[
	{
	    text:mathView_translator[0],//"Base",
	    operators:
	    [
		{
		    text:'\\(a + b\\)',
    ...
    {
	text:mathView_translator[11],//"Exposant",
	operators:
	    [
    ...
    {
	text:mathView_translator[2],//"Trigonométrie",
	operators:
	[
	    {
		text:'\\(\\sin(a)\\)',
    ...
    {
	text:mathView_translator[10],//"Trigonométrie Inverse",
	operators:
	[
    ...
    {
	text:mathView_translator[3],//"Logarithme",
	operators:
	[
	    {
		text:'\\(\\log(a)\\)',
	...
	{
	    text:mathView_translator[4],//"Interval",
	    operators:
	    [
		{
		    text:'\\([a,b]\\)',
	...
	{
	    text:mathView_translator[5],//"Autres",
	    operators:
	    [
		{
		    text:'\\(\\infty\\)',
