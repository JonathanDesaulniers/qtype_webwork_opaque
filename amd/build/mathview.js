...
define("qtype_webwork_opaque/mathview", ["jquery", "core/chart_output_chartjs"], function(a) {
	var isBootstrap5 = $.fn.tooltip.Constructor.VERSION[0] == "5"
    var b = {
        init: function init() {
	...
	function MathViewer(field, button, container, userOptions) {
		...
		this.initialize = function () {
			...
			popupttl.append($('<div>', {class: 'container-fluid p-0'})
				.append($('<ul>', {class: 'nav'})
					.append($('<div class="navbar-brand">' + mathView_translator[7] /*Éditeur d'équation*/ + '</div>'))
